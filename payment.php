...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
   ...
   <div class="container">
          <div class="jumbotron">
            <h1>Have Fun eating food</h1>
            <p>visit our website again</p>
          </div>
        </div>    
...
<h1 class="text-center">
  ...
  <a href="COD.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> Delivery now!</button></a>
</h1>
