...
<?php
$user=$_SESSION['login_user2'];
$osql="SELECT F_ID FROM ORDERS WHERE USERNAME='$user'";
$oresult = mysqli_query($conn, $osql);

if(mysqli_num_rows($oresult)>5){
   echo '<a href="cart.php?action=empty"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Empty Cart</button></a>&nbsp;<a href="foodlist.php"><button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="dpayment.php"><button class="btn btn-success"><span class="glyphicon glyphicon-gift"></span> avail coupon</button></a> 
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1>Your Shopping Cart</h1>
        <p>your food cart is empty!. Go back and <a href="foodlist.php">order now.</a></p>
...
'restaurant_name'=> $_POST["hidden_rname"]        
);
